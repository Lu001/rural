...
import com.wuzhen.common.service.GeneratorService;
import com.wuzhen.common.utils.GenUtils;
...
@RequestMapping("/admin/common/generator")
@Controller
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"wuzhen.zip\"");
